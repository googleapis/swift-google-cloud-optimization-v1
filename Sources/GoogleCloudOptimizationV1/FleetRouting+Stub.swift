...
extension Clients {
  ...
  class FleetRoutingTransport: FleetRoutingStub {
    let inner: GoogleCloudGax.HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://cloudoptimization.googleapis.com")
    }
    ...
    public func optimizeTours(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0):optimizeTours"
      }()
      let query = [
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudOptimizationV1.OptimizeToursResponse.self, from: data)
    }
    ...
    public func batchOptimizeTours(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0):batchOptimizeTours"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
